...
import proxy, { constructUrl, fetch, pathParts, article, menu } from '../index';
...
app.use('/api/article', proxy.article);
app.use('/api/menu', proxy.menu);
...
describe('API Proxy Middleware', () => {
  ...
  describe('fetch', () => {
    ...
    it('rejects if an error is returned from the API', () => {
  ...
  describe('article', () => {
    ...
    it('sets a 60s public cache header', () => {
      request.get.callsArgWith(1, null, goodResponse, testArticle);
    ...
    it('sets a content type of application/json', () => {
      request.get.callsArgWith(1, null, goodResponse, testArticle);
  ...
  describe('menu', () => {
    ...
    it('returns data', () => {
      request.get.callsArgWith(1, null, goodResponse, testMenu);
    ...
    it('sets a 1 hour (3600s) public cache header', () => {
      request.get.callsArgWith(1, null, goodResponse, testMenu);
